...
{
    public class DynamicFightBehaviour : IDynamicBehaviour
    {
        ...
        private sealed class StateDef
        {
            ...
            public string IdentifyEnemy { get { return $"{prefix}IdentifyEnemy"; } }
            public string SelectWeapon { get { return $"{prefix}SelectWeapon"; } }
            public string TrackingEnemy { get { return $"{prefix}TrackingEnemy"; } }
            public string EngagingEnemy { get { return $"{prefix}EngagingEnemy"; } }
            public string CirclingEnemy { get { return $"{prefix}CirclingEnemy"; } }
            public string AvoidFire { get { return $"{prefix}AvoidFire"; } }
            public string DoneFighting { get { return $"{prefix}DoneFighting"; } }
        ...
        private sealed class TriggerDef
        {
            ...
            public string WeaponSelected { get { return $"{prefix}WeaponSelected"; } }
            public string FoundTarget { get { return $"{prefix}FoundTarget"; } }
            public string NoTarget { get { return $"{prefix}NoTarget"; } }
            public string TargetLost { get { return $"{prefix}TargetLost"; } }
            public string Attack { get { return $"{prefix}Attack"; } }
            public string Flee { get { return $"{prefix}Flee"; } }
            public string Reposition { get { return $"{prefix}Reposition"; } }
            public string Done { get { return $"{prefix}Done"; } }
