...
namespace RagnarsRokare.MobAI
{
    public static class CommonConfig
    {
        ...
        public static void Init(ConfigFile Config)
        {
            ...
            RoamingAI = Config.Bind<bool>("General", "RoamingAI", false, "Keep area around ai-mobs active even when there is no player around. Atleast one player must be logged in however.");
        }
    }
}
