    ...
    class SearchForItemsBehaviour : IBehaviour
    {
        ...
        public void Configure(MobAIBase aiBase, StateMachine<string, string> brain, string parentState)
        {
            ...
            brain.Configure(State.SearchItemsOnGround)
                ...
                .OnEntry(t =>
                {
                    ItemDrop groundItem = Common.GetNearbyItem(m_aiBase.Instance.transform.position, Items, ItemSearchRadius);
                    if (groundItem != null)
                    {
            ...
            brain.Configure(State.SearchForRandomContainer)
                ...
                .OnEntry(t =>
                {
                    ...
                    Container nearbyChest = Common.FindRandomNearbyContainer(m_aiBase.Instance.transform.position, KnownContainers, AcceptedContainerNames, ContainerSearchRadius);
                    if (nearbyChest != null)
                    {
